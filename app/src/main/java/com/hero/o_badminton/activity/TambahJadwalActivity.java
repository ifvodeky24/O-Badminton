...
public class TambahJadwalActivity extends AppCompatActivity {
    ...
    String nama_gor, no_lapangan, id_gor, id_lapangan, hari, jam;
                ...
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        if (response.body().getMaster().size() > 0) {
                            ...
                            ArrayAdapter<String> adapter = new ArrayAdapter<>(TambahJadwalActivity.this,
                                                    ...
                                                    if (response.body().getMaster().size() > 0) {
                                                        ...
                                                        spNoLapangan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                                            ...
                                                            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                                                                ...
                                                                ArrayAdapter<CharSequence> adapterHari = ArrayAdapter.createFromResource(TambahJadwalActivity.this, R.array.hari, android.R.layout.simple_spinner_item);
                                                                ...
                                                                spHari.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                                                    ...
                                                                    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                                                                        ...
                                                                        ArrayAdapter<CharSequence> adapterJam = ArrayAdapter.createFromResource(TambahJadwalActivity.this, R.array.jam, android.R.layout.simple_spinner_item);
                                                                        ...
                                                                        spJam.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                                                            ...
                                                                            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                                                                                ...
                                                                                btnTambahJadwal.setOnClickListener(view1 -> {
                                                                                    apiService.tambahJadwal(id_lapangan, hari, jam, "Tersedia").enqueue(new Callback<TambahJadwalResponse>() {
                                                                                        @Override
                                                                                        public void onResponse(Call<TambahJadwalResponse> call, Response<TambahJadwalResponse> response) {
                                                                                            if (response.isSuccessful()) {
                                                                                                ...
                                                                                                Toast.makeText(getApplicationContext(), "Data Jadwal berhasil ditambahkan", Toast.LENGTH_SHORT).show();
